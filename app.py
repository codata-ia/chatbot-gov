...
Informe a resposta em formato HTML usando as tags de formatação de texto
...
def main():
    ...
    query_text = input("Digite a sua dúvida para o chatbot(s para sair): ")
    while query_text.lower() != "s":
